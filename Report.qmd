...
ggplot(processed_data, aes(x = Addicted_Level, fill = Addicted_Level)) +
  ...
  geom_text(stat = "count", aes(label = after_stat(count)), vjust = -0.4, color = "black", fontface = "bold", size = 4) +
  scale_fill_brewer(palette = "Blues") +
  labs(x = "Addiction Level", y = "Count of Students") +
...
ggplot(processed_data, aes(x = Addicted_Level, y = Conflicts_Over_Social_Media, color = Addicted_Level)) +
...
ggplot(percentage_summary, aes(x = Addicted_Level, y = Percentage, fill = Addicted_Level)) +
  ...
  geom_text(aes(label = round(Percentage, 1)), 
            vjust = -0.4, color = "black", fontface = "bold", size = 4) +
  scale_fill_brewer(palette = "Blues") +
  labs(x = "Addiction Level", y = "Academic Impact (%)") +
  theme_minimal(base_size = 12) +
  theme(
    axis.title = element_text(size = 12, face = "bold"),
    axis.text = element_text(size = 10),
