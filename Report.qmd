...
Research question: Will the addiction to social media reduce student's sense of self-control?
...
-   `Affects_Academic_Performance` was converted from “Yes/No” into "1/0".

-   Irrelevant variables were removed.

### 3.4. Descriptive Statistics

According to @fig-summary, the majority of the sample had *medium* (300 students) to *high* (400 students) levels of addiction. While the figure for the low group was only 20.
...
-   Affects_Academic_Performance: 64% of students agreed that their studies have been impacted negatively by using social media.
