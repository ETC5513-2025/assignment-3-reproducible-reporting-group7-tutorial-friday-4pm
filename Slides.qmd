...
The dataset includes survey responses from **705 students** (Kaggle, 2024), covering behavioral and academic aspects of social media use.
...
→ 100% of students in the High addiction group reported academic impact
...
<div style="height: 100%; display: flex; justify-content: center; align-items: center;">
  <h1 style="color:#3182bd; font-size:60px;">Thank You for Listening!</h1>
</div>
